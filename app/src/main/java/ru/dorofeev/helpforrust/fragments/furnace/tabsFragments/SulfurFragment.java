...
public class SulfurFragment extends Fragment {

    @BindView(R.id.furnaceList)
    RecyclerView furnaceList;
    private static SulfurFragment instance;
    private static List<Furnace> furnaces;
    private Unbinder unbinder;
    private FurnaceAdapter adapter;

    public static SulfurFragment getInstance(List<Furnace> furnaceList) {
        furnaces = furnaceList;
        if (instance == null) {
            instance = new SulfurFragment();
        }
        return instance;
    }
